package com.gmail.andrewandy.config;
...
public class Config extends YamlConfiguration {
    ...
    private JavaPlugin instance = FunTest.getInstance();
    ...
    public Config(String fileName, boolean useDefaults) {
        ...
        if (useDefaults) {
            ...
            this.defaults = YamlConfiguration.loadConfiguration(new InputStreamReader(instance.getClass().getResourceAsStream("/" + fileName), StandardCharsets.UTF_8));
